...
return [
    ...
    */
    ...
    'after_or_equal' => 'Le champ :attribute doit être a date after or equal to :date.',
    ...
    'array' => 'Le champ :attribute doit être an array.',
    'before' => 'Le champ :attribute doit être a date before :date.',
    'before_or_equal' => 'Le champ :attribute doit être a date before or equal to :date.',
    'between' => [
        'numeric' => 'Le champ :attribute doit être between :min and :max.',
        'file' => 'Le champ :attribute doit être between :min and :max kilobytes.',
        'string' => 'Le champ :attribute doit être between :min and :max caractères.',
    ...
    'digits_between' => 'Le champ :attribute doit être between :min and :max digits.',
